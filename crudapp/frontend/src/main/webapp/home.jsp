            ...
            <div class="modal-content">
                ...
                <form id="addForm" action="AddUserServlet" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="radio" id="gender" name="gender" value="Others">Others </td>
                    </div>
                    </tr>
        ...
        <div id="editModal" class="modal hidden">
            <div class="modal-content">
                ...
                <form id="editForm" action="ModifyServlet" method="post">
                    ...
                    <tr>
                    <div class="form-group">
                        <td><label for="editDob">Date-Of-Birth:</label></td>
                        <td><input type="text" id="editDob" name="dob"></td>
                    </div>
                    </tr>
                    <tr>
                    <tr>
                    <div class="form-group">
                        ...
                        <td><input type="text" id="editGender" name="gender"></td>
                    </div>
                    </tr>
                    <tr>
                    <div class="form-group">
...
<td><a href="delete?userId=<%=user.getId() %>" class="btn">Delete</a>
<button id="editButton"  class="edit btn" onclick="editUser(<%=user.getId() %>, '<%=user.getName() %>', '<%=user.getEmail() %>', '<%=user.getPassword() %>','<%=user.getDob() %>','<%=user.getGender() %>', '<%=user.getPhonenumber() %>', '<%=user.getAddress() %>')">Edit</button>
</td>
</tr>
<%} %>
<%} %>
...
<script>
        ...
        function editUser(userId, name, email,password,dob,gender, mobile, address) {
